...
public partial class Core : ThinkingObject
{
    ...
    public override void _Ready()
    {
        ...
        new([
              ...
              [new Part.BrainWord.CheckInput("ArmLeft", Part.BrainWord.CheckInput.InputType.JustPressed), new Part.BrainWord.Action.Pass(new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.IntFlag, "1"), false), new Part.BrainWord.Action.PartSettings(new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.StringFlag, "Angle"), new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.IntFlag, "-75"), Part.BrainWord.Flag.Math.Operation.Set)],
              [new Part.BrainWord.CheckInput("ArmRight", Part.BrainWord.CheckInput.InputType.JustPressed), new Part.BrainWord.Action.Pass(new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.IntFlag, "1"), false), new Part.BrainWord.Action.PartSettings(new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.StringFlag, "Angle"), new Part.BrainWord.Flag.Value.Constant(Part.BrainWord.Flag.FlagType.IntFlag, "75"), Part.BrainWord.Flag.Math.Operation.Set)],
